...
uint32 Battleground::GetBonusHonorFromKill(uint32 kills) const
{
    ...
    return SurgeCore::Honor::hk_honor_at_level(maxLevel, float(kills));
}
...
void Battleground::SendMessageToAll(int32 entry, ChatMsg type, Player const* source)
{
    ...
    SurgeCore::BattlegroundChatBuilder bg_builder(type, entry, source);
    SurgeCore::LocalizedPacketDo<SurgeCore::BattlegroundChatBuilder> bg_do(bg_builder);
...
void Battleground::PSendMessageToAll(int32 entry, ChatMsg type, Player const* source, ...)
{
    ...
    SurgeCore::BattlegroundChatBuilder bg_builder(type, entry, source, &ap);
    SurgeCore::LocalizedPacketDo<SurgeCore::BattlegroundChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
...
{
    SurgeCore::Battleground2ChatBuilder bg_builder(type, entry, source, arg1, arg2);
    SurgeCore::LocalizedPacketDo<SurgeCore::Battleground2ChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
}
