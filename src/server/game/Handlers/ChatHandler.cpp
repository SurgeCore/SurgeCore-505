...
void WorldSession::HandleTextEmoteOpcode(WorldPacket & recvData)
{
    ...
    CellCoord p = SurgeCore::ComputeCellCoord(GetPlayer()->GetPositionX(), GetPlayer()->GetPositionY());

    Cell cell(p);
    cell.SetNoCreate();

    SurgeCore::EmoteChatBuilder emote_builder(*GetPlayer(), text_emote, emoteNum, unit);
    SurgeCore::LocalizedPacketDo<SurgeCore::EmoteChatBuilder > emote_do(emote_builder);
    SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::EmoteChatBuilder > > emote_worker(GetPlayer(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE), emote_do);
    TypeContainerVisitor<SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::EmoteChatBuilder> >, WorldTypeMapContainer> message(emote_worker);
