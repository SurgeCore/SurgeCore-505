...
class MapInstanced;
class InstanceMap;
namespace SurgeCore { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<SurgeCore::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<SurgeCore::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(SurgeCore::ComputeGridCoord(x, y));
        }
