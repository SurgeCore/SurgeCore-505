...
bool OPvPCapturePoint::Update(uint32 diff)
{
    ...
    SurgeCore::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    SurgeCore::PlayerListSearcher<SurgeCore::AnyPlayerInObjectRangeCheck> searcher(m_capturePoint, players, checker);
