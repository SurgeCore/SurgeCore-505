...
void World::SendWorldText(int32 string_id, ...)
{
    ...
    SurgeCore::WorldWorldTextBuilder wt_builder(string_id, &ap);
    SurgeCore::LocalizedPacketListDo<SurgeCore::WorldWorldTextBuilder> wt_do(wt_builder);
...
void World::SendAutoBroadcast()
{
    ...
    msg = SurgeCore::Containers::SelectRandomContainerElement(m_Autobroadcasts);
