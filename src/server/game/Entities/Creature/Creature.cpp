...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        Cell cell(p);
        cell.SetNoCreate();
        SurgeCore::NearestAssistCreatureInCreatureRangeCheck u_check(this, getVictim(), radius);
        SurgeCore::CreatureLastSearcher<SurgeCore::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);

        TypeContainerVisitor<SurgeCore::CreatureLastSearcher<SurgeCore::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        SurgeCore::NearestHostileUnitCheck u_check(this, dist);
        SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetNoCC(float dist) const
{
...

    {
        ...
        SurgeCore::NearestHostileNoCCUnitCheck u_check(this, dist);
        SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileNoCCUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileNoCCUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileNoCCUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
        SurgeCore::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<SurgeCore::UnitLastSearcher<SurgeCore::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Player* Creature::SelectNearestPlayer(float distance) const
{
    ...
    SurgeCore::NearestPlayerInObjectRangeCheck checker(this, distance);
    SurgeCore::PlayerLastSearcher<SurgeCore::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
...
Player* Creature::SelectNearestPlayerNotGM(float distance) const
{
    ...
    SurgeCore::NearestPlayerNotGMInObjectRangeCheck checker(this, distance);
    SurgeCore::PlayerLastSearcher<SurgeCore::NearestPlayerNotGMInObjectRangeCheck> searcher(this, target, checker);
    VisitNearbyObject(distance, searcher);
    ...
    if (!m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                SurgeCore::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                SurgeCore::CreatureListSearcher<SurgeCore::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<SurgeCore::CreatureListSearcher<SurgeCore::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float radius)
{
    ...
    SurgeCore::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), radius);
    SurgeCore::CreatureWorker<SurgeCore::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<SurgeCore::CreatureWorker<SurgeCore::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
...
void Creature::SetPosition(float x, float y, float z, float o)
{
    ...
    if (!SurgeCore::IsValidMapCoord(x, y, z, o))
    {
