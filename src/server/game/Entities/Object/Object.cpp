...
void WorldObject::GetRandomPoint(const Position &pos, float distance, float &rand_x, float &rand_y, float &rand_z) const
{
    ...
    SurgeCore::NormalizeMapCoord(rand_x);
    SurgeCore::NormalizeMapCoord(rand_y);
...
{
    return SurgeCore::IsValidMapCoord(m_positionX, m_positionY, m_positionZ, m_orientation);
}
...
{
    CellCoord p = SurgeCore::ComputeCellCoord(GetPositionX(), GetPositionY());

    Cell cell(p);
    cell.SetNoCreate();

    SurgeCore::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, text, language, TargetGuid);
    SurgeCore::LocalizedPacketDo<SurgeCore::MonsterCustomChatBuilder> say_do(say_build);
    SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterSay(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    SurgeCore::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, textId, language, TargetGuid);
    SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> say_do(say_build);
    SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY));
}
...
void WorldObject::MonsterYell(const char* text, uint32 language, uint64 TargetGuid)
{
    ...
    SurgeCore::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, text, language, TargetGuid);
    SurgeCore::LocalizedPacketDo<SurgeCore::MonsterCustomChatBuilder> say_do(say_build);
    SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterYell(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    SurgeCore::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, textId, language, TargetGuid);
    SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> say_do(say_build);
    SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL));
}
...
void WorldObject::MonsterTextEmote(int32 textId, uint64 TargetGuid, bool IsBossEmote)
{
    ...
    SurgeCore::MonsterChatBuilder say_build(*this, IsBossEmote ? CHAT_MSG_RAID_BOSS_EMOTE : CHAT_MSG_MONSTER_EMOTE, textId, LANG_UNIVERSAL, TargetGuid);
    SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> say_do(say_build);
    SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE), say_do);
    TypeContainerVisitor<SurgeCore::PlayerDistWorker<SurgeCore::LocalizedPacketDo<SurgeCore::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
{
    SurgeCore::MessageDistDeliverer notifier(this, data, dist);
    VisitNearbyWorldObject(dist, notifier);
}

void WorldObject::SendMessageToSet(WorldPacket* data, Player const* skipped_rcvr)
{
    SurgeCore::MessageDistDeliverer notifier(this, data, GetVisibilityRange(), false, skipped_rcvr);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive) const
{
    ...
    SurgeCore::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    SurgeCore::CreatureLastSearcher<SurgeCore::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
{
    GameObject* go = NULL;
    SurgeCore::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    SurgeCore::GameObjectLastSearcher<SurgeCore::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{ 
    GameObject* go = NULL;
    SurgeCore::NearestGameObjectTypeInObjectRangeCheck checker(*this, type, range);
    SurgeCore::GameObjectLastSearcher<SurgeCore::NearestGameObjectTypeInObjectRangeCheck> searcher(this, go, checker);
    VisitNearbyGridObject(range, searcher);
    return go;
}
...
{
    CellCoord pair(SurgeCore::ComputeCellCoord(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    SurgeCore::AllGameObjectsWithEntryInRange check(this, entry, maxSearchRange);
    SurgeCore::GameObjectListSearcher<SurgeCore::AllGameObjectsWithEntryInRange> searcher(this, gameobjectList, check);
    TypeContainerVisitor<SurgeCore::GameObjectListSearcher<SurgeCore::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& creatureList, uint32 entry, float maxSearchRange) const
{
    ...
    SurgeCore::AllCreaturesOfEntryInRange check(this, entry, maxSearchRange);
    SurgeCore::CreatureListSearcher<SurgeCore::AllCreaturesOfEntryInRange> searcher(this, creatureList, check);
    TypeContainerVisitor<SurgeCore::CreatureListSearcher<SurgeCore::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
{    
    SurgeCore::AnyPlayerInObjectRangeCheck checker(this, maxSearchRange);
    SurgeCore::PlayerListSearcher<SurgeCore::AnyPlayerInObjectRangeCheck> searcher(this, playerList, checker);
...
void WorldObject::GetNearPoint2D(float &x, float &y, float distance2d, float absAngle) const
{
    ...
    SurgeCore::NormalizeMapCoord(x);
    SurgeCore::NormalizeMapCoord(y);
}
...
void WorldObject::GetNearPoint(WorldObject const* searcher, float &x, float &y, float &z, float searcher_size, float distance2d, float absAngle) const
{
    ...
    // adding used positions around object
    {
        ...
        SurgeCore::NearUsedPosDo u_do(*this, searcher, absAngle, selector);
        SurgeCore::WorldObjectWorker<SurgeCore::NearUsedPosDo> worker(this, u_do);

        TypeContainerVisitor<SurgeCore::WorldObjectWorker<SurgeCore::NearUsedPosDo>, GridTypeMapContainer  > grid_obj_worker(worker);
        TypeContainerVisitor<SurgeCore::WorldObjectWorker<SurgeCore::NearUsedPosDo>, WorldTypeMapContainer > world_obj_worker(worker);
...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
    ...
    if (!SurgeCore::IsValidMapCoord(destx, desty))
    {
    ...
    SurgeCore::NormalizeMapCoord(pos.m_positionX);
    SurgeCore::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    SurgeCore::AnyPlayerInObjectRangeCheck check(this, GetVisibilityRange(), false);
    SurgeCore::PlayerListSearcher<SurgeCore::AnyPlayerInObjectRangeCheck> searcher(this, targets, check);
...
void WorldObject::UpdateObjectVisibility(bool /*forced*/)
{
    ...
    SurgeCore::VisibleChangesNotifier notifier(*this);
    VisitNearbyWorldObject(GetVisibilityRange(), notifier);
}
