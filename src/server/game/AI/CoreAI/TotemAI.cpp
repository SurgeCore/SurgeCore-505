...
void TotemAI::UpdateAI(uint32 const /*diff*/)
{
    ...
    {
        victim = NULL;
        SurgeCore::NearestAttackableNoCCUnitInObjectRangeCheck u_check(me, me, max_range);
        SurgeCore::UnitLastSearcher<SurgeCore::NearestAttackableNoCCUnitInObjectRangeCheck> checker(me, victim, u_check);
