...
class SmartScript
{
    public:
        ...
        Creature* FindCreatureNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            SurgeCore::CreatureWithDbGUIDCheck target_check(searchObject, guid);
            SurgeCore::CreatureSearcher<SurgeCore::CreatureWithDbGUIDCheck> checker(searchObject, creature, target_check);
