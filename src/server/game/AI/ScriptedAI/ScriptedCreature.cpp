...
std::list<Creature*> ScriptedAI::DoFindFriendlyCC(float range)
{
    ...
    SurgeCore::CreatureListSearcher<SurgeCore::FriendlyCCedInRange> searcher(me, list, u_check);
    me->VisitNearbyObject(range, searcher);
    return list;
}
...
{
    std::list<Creature*> list;
    SurgeCore::FriendlyMissingBuffInRange u_check(me, range, uiSpellid);
...
Player* ScriptedAI::GetPlayerAtMinimumRange(float minimumRange)
{
    ...
    CellCoord pair(SurgeCore::ComputeCellCoord(me->GetPositionX(), me->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    SurgeCore::PlayerAtMinimumRangeAway check(me, minimumRange);
    SurgeCore::PlayerSearcher<SurgeCore::PlayerAtMinimumRangeAway> searcher(me, player, check);
    TypeContainerVisitor<SurgeCore::PlayerSearcher<SurgeCore::PlayerAtMinimumRangeAway>, GridTypeMapContainer> visitor(searcher);
