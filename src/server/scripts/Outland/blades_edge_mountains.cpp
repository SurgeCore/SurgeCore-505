        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                SurgeCore::AllWorldObjectsInRange objects(me, searchDistance);
                SurgeCore::WorldObjectListSearcher<SurgeCore::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
