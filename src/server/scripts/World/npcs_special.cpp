    ...
    public:
        ...
        struct npc_ebon_gargoyleAI : CasterAI
        {
            ...
            void DoSearchTarget()
            {
                ...
                SurgeCore::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 30);
                SurgeCore::UnitListSearcher<SurgeCore::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
    ...
    public:
        ...
        struct npc_ring_of_frostAI : public Scripted_NoMovementAI
        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                std::list<Unit*> targets;
                SurgeCore::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 5.0f);
                SurgeCore::UnitListSearcher<SurgeCore::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
