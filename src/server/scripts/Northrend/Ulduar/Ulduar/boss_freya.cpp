                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_NATURE_BOMB:
                        {
                            ...
                            SurgeCore::AnyPlayerInObjectRangeCheck checker(me, 50.0f);
                            SurgeCore::PlayerListSearcher<SurgeCore::AnyPlayerInObjectRangeCheck> searcher(me, PlayerList, checker);
