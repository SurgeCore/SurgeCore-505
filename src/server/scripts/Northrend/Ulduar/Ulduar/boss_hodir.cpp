    ...
    public:
        ...
        struct boss_hodirAI : public BossAI
        {
            ...
            void FlashFreeze()
            {
                ...
                SurgeCore::AnyUnfriendlyUnitInObjectRangeCheck checker(me, me, 100.0f);
                SurgeCore::UnitListSearcher<SurgeCore::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
            ...
            void UpdateAI(uint32 const diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        {
                            std::list<Unit*> TargetList;
                            SurgeCore::AnyFriendlyUnitInObjectRangeCheck checker(me, me, 30.0f);
                            SurgeCore::UnitListSearcher<SurgeCore::AnyFriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
