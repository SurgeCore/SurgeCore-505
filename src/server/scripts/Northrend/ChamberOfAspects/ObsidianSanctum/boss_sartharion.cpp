...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        void CastLavaStrikeOnTarget(Unit* target)
        {
            ...
            SurgeCore::AllCreaturesOfEntryInRange checker(me, NPC_FIRE_CYCLONE, 200.0f);
            SurgeCore::CreatureListSearcher<SurgeCore::AllCreaturesOfEntryInRange> searcher(me, pFireCyclonesList, checker);
