    ...
    public:
        ...
        class spell_q11010_q11102_q11023_choose_loc_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                SurgeCore::AnyPlayerInObjectRangeCheck checker(caster, 765.0f);
                SurgeCore::PlayerListSearcher<SurgeCore::AnyPlayerInObjectRangeCheck> searcher(caster, PlayerList, checker);
