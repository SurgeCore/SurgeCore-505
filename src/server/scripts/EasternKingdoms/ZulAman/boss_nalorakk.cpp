        ...
        struct boss_nalorakkAI : public ScriptedAI
        {
            ...
            void SendAttacker(Unit* target)
            {
...

                {
                    ...
                    SurgeCore::AllFriendlyCreaturesInGrid check(me);
                    SurgeCore::CreatureListSearcher<SurgeCore::AllFriendlyCreaturesInGrid> searcher(me, templist, check);

                    TypeContainerVisitor<SurgeCore::CreatureListSearcher<SurgeCore::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
