        ...
        //        DoZoneInCombat();
            ...
            bool HatchAllEggs(uint32 action) //1: reset, 2: isHatching all
            {
...

                {
                    ...
                    SurgeCore::AllCreaturesOfEntryInRange check(me, MOB_EGG, 100);
                    SurgeCore::CreatureListSearcher<SurgeCore::AllCreaturesOfEntryInRange> searcher(me, templist, check);

                    TypeContainerVisitor<SurgeCore::CreatureListSearcher<SurgeCore::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
            ...
            void Boom()
            {
...

                {
                    ...
                    SurgeCore::AllCreaturesOfEntryInRange check(me, MOB_FIRE_BOMB, 100);
                    SurgeCore::CreatureListSearcher<SurgeCore::AllCreaturesOfEntryInRange> searcher(me, templist, check);
        ...
        struct mob_janalai_hatcherAI : public ScriptedAI
        {
            ...
            bool HatchEggs(uint32 num)
            {
...

                {
                    ...
                    SurgeCore::AllCreaturesOfEntryInRange check(me, 23817, 50);
                    SurgeCore::CreatureListSearcher<SurgeCore::AllCreaturesOfEntryInRange> searcher(me, templist, check);
